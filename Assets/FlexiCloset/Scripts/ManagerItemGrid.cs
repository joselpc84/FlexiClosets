...
public class ManagerItemGrid : PersistentSingleton<ManagerItemGrid>
{
    ...
    public float OffSetTextUp = 1.5f;
    ...
    public void ShowDistanceWall()
    {
        ...
        for (int i = 0; i < testWallsLR.Count; i++)
        {
            ...
            Vector3 poosAux = (rightstore.transform.position + dir.normalized * dir.magnitude * 0.5f) + Vector3.up * OffSetTextUp * rightstore.HighValue;
            pos.Add(poosAux);
        }
        ...
        for (int i = 0; i < testWallUD.Count; i++)
        {
            ...
            Vector3 poosAux = (upstore.transform.position + dir.normalized * dir.magnitude * 0.5f) + Vector3.up * OffSetTextUp * upstore.HighValue;
            pos.Add(poosAux);
        }
