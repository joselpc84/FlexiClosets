...
namespace SmartFPSMeter.Data
{
    ...
    /// </summary>
    [System.Serializable]
    public class FramesData : BaseData
    {
        internal FramesData()
        {
            Anchor = TextAnchor.UpperRight;
            MyColor = new Color32( 0, 238, 0, 255 );
        }
        ...
        [SerializeField]
        private Color32 warningColor = new Color32( 238, 238, 0, 255 );
        private string currentWarningColor = string.Empty;

        [SerializeField]
        private Color32 dangerColor = new Color32( 238, 0, 0, 255 );
        private string currentDangerColor = string.Empty;

        // CountFPS
        private float lastFpsInterval, lastMinMaxInterval;
        private float frames = 0f;
        private float fps, minfps, maxfps;
        private float ms, minms, maxms;
