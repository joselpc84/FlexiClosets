...
namespace SmartFPSMeter.Data
{
    ...
    /// </summary>
    [System.Serializable]
    public class MemoryData : BaseData
    {
        internal MemoryData()
        {
            Anchor = TextAnchor.LowerRight;
            MyColor = new Color32( 0, 238, 238, 255 );
        }
        ...
        private float monoUsedSize, totalAllocatedMemory, totalReservedMemory;
