...
namespace SmartFPSMeter
{
    ...
    public class MainMeter : MonoBehaviour
    {
        ...
        /// </summary>
        public FramesData fpsData = new FramesData();

        /// <summary>
        /// Mono, total Allocated & total Reserved memory meter.
        /// </summary>
        public MemoryData memData = new MemoryData();
        ...
        public static MainMeter Instance
        {
            get
            {
                if( !instance )
                {
                    ...
                    if( !instance ) 
                        Debug.LogError( "ERROR: Component [MainMeter] not found!" ); 
                }
                return instance;
            }
        }
        ...
        public void MeterSetup()
        {
            ...
            else if( anchorsCount > textLabels.Length )
            {
                textLabels = null;
                textLabels = new TextLabel[ anchorsCount ];
            }
        ...
        void OnEnable()
        {
            ...
            if( meterMode == MeterModes.Background ) 
                return;
        ...
        // SetText
        internal void SetAllText( bool setalign = false)
        {
            if( meterMode == MeterModes.Disable ) 
                return;
